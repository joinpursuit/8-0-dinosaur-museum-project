...
// return a description of dinosaur or return an error message
//define our loop
// if the id is equal to dinosaurs[i].dinosaurID
// then dinosaurs[i] = foundDino
 ...
 *  //> ["WHQcpcOj0G"]
 */
//returning an array of dinosaurs who lived at the given  time period

// create new empty array ==> dinoArray
// define our loop
// if mya is <= dinosaurs.mya[0] and if mya >= dinosaurs.mya[1] 
// then push dinosaurs[i].dinosaurId into dinoArray 
// if the length of dinosaurs.mya is 1 and mya = dinosaurs.mya[0] 
//if the length of dinosaurs.mya is 1 and mya + 1 = dinosaurs.mya[0]   
