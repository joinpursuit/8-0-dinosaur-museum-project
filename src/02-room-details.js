...
function getRoomByDinosaurName(dinosaurs, rooms, dinosaurName) {
    ...
    // variable sto hold the value if the dinosaur and the room exits intitalized to false
    let dinoFound = false
    let roomFound = false
    ...
    for(let dinosaur of dinosaurs){
        ...
        //check if the user supplied name exists in the array of objects
    ...
    //iterate through the roooms object
    ...
    // if the room is found return the roomname else return the message that the dinosaur 
    //cannot be found
    if(roomFound){
      return roomName
    }
 ...
 */// Test Messages
           ...
           if(room.roomId === id){
            ...
            //  console.log("room id matched",roomId)
              ...
              for(let connection of roomConnected){
                ...
                for(let ele of rooms){
                  //console.log("ele=",ele)

                  //assign the values of roomid and roomname to the variables
                  roomIdMatch=ele.roomId
                  roomNameMatch=ele.name
    ...
    // check if room is found 
     ...
     //return error message if it is an invalid roomId or connected room id
