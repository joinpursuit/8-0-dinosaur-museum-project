...
function purchaseTickets(ticketData, purchases) {
  ...
  for (let i = 0; i < purchases.length; i++) {
    if (purchases[i].extras.includes('incorrect-extra')){
      ...
      purchases[i].ticketType !== "general" &&
      ...
      recieptData = `Thank you for visiting the Dinosaur Museum!\n-------------------------------------------\n${purchases[i].entrantType[0].toUpperCase()}${purchases[i].entrantType.substring(1)} ${purchases[i].ticketType[0].toUpperCase()}${purchases[i].ticketType.substring(1)}Admission: $${finalPrice*.01} \n-------------------------------------------\nTOTAL: $${finalPrice.toFixed(
        2
      )}`;
