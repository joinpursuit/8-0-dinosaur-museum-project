...
// create a ticketprice variablw which is a number
//access ticketData using a for loop. do we even need since ticketinfo basically covers that?
 ...
 *
 * Any errors that would occur as a result of incorrect ticket information should be 
 * surfaced in the same way it is in the previous function.
 * 
